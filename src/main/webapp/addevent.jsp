...
<head>
    ...
    <style>
        body {
            ...
            background-color: #2c6b2f; /* Dark green background */
        }

        .sidebar {
            width: 220px;
            background-color: #1b4d1f; /* Dark green for sidebar */
            position: fixed;
            height: 100%;
            overflow: auto;
            text-align: center;
   ...
   <div class="sidebar">
    ...
    <div class="content">
        ...
        <form action="insertevent" method="post">
            ...
            <textarea id="edescription" name="edescription" required></textarea><br><br>
            
            <label for="edate">Date:</label>
            <input type="date" id="edate" name="edate" required><br><br>
            
            <label for="elocation">Location:</label>
            <input type="text" id="elocation" name="elocation" required><br><br>
